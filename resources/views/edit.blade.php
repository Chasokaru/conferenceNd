            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">
                        <h3 class="card-title">Edit Conference List</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('conferences.update', $conference) }}" method="POST">
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-primary" style="height: 50px; background-color: #a6530e; color: white; border-color: #a6530e;">Update Conference</button>
                            </div>
                        </form>
                    </div>
                </div>
